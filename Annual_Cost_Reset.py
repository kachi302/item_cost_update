...
print(
    "Annual Cost Reset Process, 3초후 시작 됩니다. 해당 화면을 Main 모니터가 아닌 다른 모니터로 이동 하세요."
)
# time.sleep(3)
            ...
            for cell in row:  # type: ignore
                ...
                if item_mp != None:
                    ...
                    if ri != None:
                        ...
                        ri_undefault = pyautogui.locateOnScreen(
                            r".\images\item_cost_not_default.png"
                        )
                        ...
                        if ri_undefault != None:
                            ...
                            pyautogui.click(
                                ri_undefault_c.x + 115, ri_undefault_c.y + 10
                            )
                            time.sleep(0.9)
                            ...
                            pyautogui.click(
                                ri_undefault_c.x + 118, ri_undefault_c.y + 10
                            )
                            time.sleep(0.9)
                            pyautogui.hotkey("ctrl", "s")
                            # close_form()
                            ...
                            inv_asset = pyautogui.locateOnScreen(
                                r".\images\inv_asset.png"
                            )
                            if inv_asset != None:
                                time.sleep(0.9)
                                # cost_btn = pyautogui.locateOnScreen(resource_path(r'images\costs_btn.png'))
                                cost_btn = pyautogui.locateOnScreen(
                                    r".\images\costs_btn.png"
                                )
